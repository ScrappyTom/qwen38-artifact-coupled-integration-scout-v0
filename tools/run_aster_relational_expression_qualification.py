...
SCOPE = "aster_relational_expression_qualification_v0"
MAX_CALLS = 1
CONTEXT_TOKENS = 25_088
TASK = ROOT / "task_aster"
CONTRACT = ROOT / "ASTER_RELATIONAL_EXPRESSION_QUALIFICATION_CONTRACT.json"
SAFETY = ROOT / "ASTER_RELATIONAL_EXPRESSION_SAFETY_CONTRACT.json"
REQUEST = ROOT / "ASTER_RELATIONAL_EXPRESSION_AUTHORIZATION_REQUEST.json"
PREFLIGHT = ROOT / "ASTER_RELATIONAL_EXPRESSION_PREFLIGHT.json"
...
def main() -> int:
    ...
    write_json(
        ...
        {
            "schema": "aster-relational-expression-qualification-freeze-v0",
            "commit": git_commit(),
            "run_id": RUN_ID,
            ...
            "safety_contract_sha256": sha256_file(SAFETY),
    ...
    try:
        ...
        if prompt_tokens + SOURCE_DELTA_PROVIDER_MAX_TOKENS > CONTEXT_TOKENS:
        ...
        provider = complete_custodied(
            provider_payload(
                ...
                case.seed,
                {"type": "text"},
                max_tokens=SOURCE_DELTA_PROVIDER_MAX_TOKENS,
            ),
        ...
        catalog = load(TASK / "SOURCE_CATALOG.json")
        source_catalog = {
            str(row["source_id"]): row for row in catalog.get("sources", [])
        }
        ...
        result = {
            "schema": "aster-relational-expression-result-v0",
            "run_id": RUN_ID,
        ...
        write_json(
            run_root / "FINALIZATION.json", {"failure": failure, "release": release}
        )
