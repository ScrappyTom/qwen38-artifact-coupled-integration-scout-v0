...
STAGE0 = ROOT / "TRELLIS_E97_VERIFICATION_LIFECYCLE_STAGE0.json"
...
def external_evaluation(candidate_root: Path, output_path: Path) -> dict[str, Any]:
    ...
    receipt = {
        ...
        "schema": "trellis-e97-checkpoint-external-evaluation-v0",
...
def main() -> int:
    ...
    write_json(
        run_root / "FREEZE_BINDING.json",
        {
            ...
            "run_id": RUN_ID,
            "schema": "trellis-e97-verification-lifecycle-freeze-binding-v0",
    ...
    try:
        ...
        live_preflight = {
            ...
            "schema": "trellis-e97-live-migration-preflight-v0",
        ...
        result = {
            ...
            "run_id": RUN_ID,
            "schema": "trellis-e97-verification-lifecycle-result-v0",
