...
from tools.materialize_keystone_world import SPECS, document
...
def main() -> int:
    ...
    for spec in SPECS:
        ...
        custody.append(
            {
                **row,
                "origin": "deterministic_synthetic_keystone_rail_world_v0",
                "generator": "tools/materialize_keystone_world.py",
            }
        )
    write_json(
        TASK / "SOURCE_CATALOG.json",
        {"schema": "keystone-source-catalog-v0", "sources": sources},
    )
    governed = [
        "ACTIONS.md",
    ...
    write_json(
        ...
        {
            "schema": "keystone-task-source-lock-v0",
            "task_id": TASK_ID,
            "world_origin": "deterministic_synthetic_keystone_rail_world_v0",
