...
SCOPE = "solace_anchored_provenance_pressure_screen_v0"
...
CONTRACT = ROOT / "SOLACE_PRESSURE_SCREEN_CONTRACT.json"
...
def main() -> int:
    ...
    try:
        ...
        tokenizer = LiveTokenizer()
        world = SolaceWorld(TASK, run_root / "trajectory")
        ledger = ResultLedger()
        ...
        for actor_call in range(1, MAX_CALLS + 1):
            ...
            if prompt_tokens > PROMPT_LIMIT:
                ...
                boundary = {
                    "schema": "solace-authentic-interaction-pressure-boundary-v0",
                    "task_id": TASK_ID,
            ...
            schema = action_json_schema(
                ...
                schema_name="solace_common_actor_action_v0",
            )
