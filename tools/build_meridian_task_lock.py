...
def main() -> int:
    ...
    for source_id, spec in zip(SOURCE_IDS, SPECS, strict=True):
        ...
        custody.append(
            {
                **row,
                "origin": "deterministic_synthetic_meridian_infusion_world_v0",
                "generator": "tools/materialize_meridian_world.py",
    ...
    write_json(
        ...
        {"schema": "meridian-source-catalog-v0", "sources": sources},
    )
    governed = [
        "ACTIONS.md",
        "EVALUATOR.json",
    ...
    write_json(
        ...
        {
            "schema": "meridian-task-source-lock-v0",
            "task_id": TASK_ID,
            "world_origin": "deterministic_synthetic_meridian_infusion_world_v0",
