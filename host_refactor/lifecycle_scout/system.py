...
RUN_ID = "2026-08-29-trellis-e97-verification-lifecycle-scout-v0"
SCOPE = "trellis_e97_verification_lifecycle_scout_v0"
...
SCOUT_CONFIGURATION_ID = "V1_E97_DONOR_DERIVED_LIFECYCLE"


def lifecycle_scout_execution_manifest(repository_root: Path) -> dict[str, Any]:
    root = repository_root.resolve()
    base = trellis_execution_manifest(root)
    declared = (
        root / "TRELLIS_E97_VERIFICATION_LIFECYCLE_SCOUT_CONTRACT.json",
        root / "TRELLIS_E97_VERIFICATION_LIFECYCLE_SCOUT_AUTHORIZATION_REQUEST.json",
        ...
        root / "host_refactor" / "lifecycle_scout" / "__init__.py",
        ...
        root / "host_refactor" / "lifecycle_scout" / "system.py",
        ...
        root / "tools" / "run_e97_verification_lifecycle_scout.py",
        root / "tools" / "build_e97_verification_lifecycle_stage0.py",
    )
    payload = {
        ...
        "schema": "trellis-e97-verification-lifecycle-execution-manifest-v0",
    }
    return {
        **payload,
...
def lifecycle_scout_spec(repository_root: Path) -> TrellisRuntimeSpec:
    ...
    manifest = lifecycle_scout_execution_manifest(repository_root)
    return replace(
        base,
        ...
        paths=replace(
            ...
            contract_path=(
                repository_root
                / "TRELLIS_E97_VERIFICATION_LIFECYCLE_SCOUT_CONTRACT.json"
            ),
...
def build_lifecycle_scout_system(
    *,
